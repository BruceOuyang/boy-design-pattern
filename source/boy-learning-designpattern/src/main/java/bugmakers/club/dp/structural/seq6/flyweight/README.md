...
![图14-5 引入外部状态之后的围棋棋子结构图](https://upload-images.jianshu.io/upload_images/5792176-64839175467544b2.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)  
...
![图14-6 单纯享元模式结构图](https://upload-images.jianshu.io/upload_images/5792176-f1d03394cc58c05e.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)  
图14-6 单纯享元模式结构图  

2.复合享元模式

将一些单纯享元对象使用组合模式加以组合，还可以形成复合享元对象，这样的复合享元对象本身不能共享，但是它们可以分解成单纯享元对象，而后者则可以共享。复合享元模式的结构如图14-7所示：  
![图14-7 复合享元模式结构图](https://upload-images.jianshu.io/upload_images/5792176-551ed9e3d172a8d3.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)  
图14-7 复合享元模式结构图  
